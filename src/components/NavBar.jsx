...
const Navbar = () => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 h-16 bg-gradient-to-r from-blue-600 to-indigo-700 flex items-center">
  ...
  } transition-all duration-100 sm:h-fit sm:bg-none bg-gradient-to-r from-blue-600 to-indigo-700 sm:w-fit w-full sm:flex-row flex-col px-4 sm:px-0`}
>

          <li className="hover:text-blue-500 font-medium transition-all duration-150 text-white">
            <Link
              className={`${
